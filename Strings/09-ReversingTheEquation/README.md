## Problem : Reversing the Equation (Easy)
...
reverseEqn() which takes the string S representing the equation as input and returns the 
resultant string representing the equation in reverse.
```
...
<li>The string contains only the characters '0' - '9', '+', '-', '*', and '/'.</li>
