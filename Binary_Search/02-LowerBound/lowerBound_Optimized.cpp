...
// Function to find the lower bound of 'x' in a sorted vector 'arr' using binary search
...
int main() {
    ...
    if (result1 != n1) {
        cout << "Lower bound of " << x1 << " in sample input 1 is at index " << result1 << ". Element: " << arr1[result1] << endl;
    } else {
    ...
    if (result2 != n2) {
        cout << "Lower bound of " << x2 << " in sample input 2 is at index " << result2 << ". Element: " << arr2[result2] << endl;
    } else {
