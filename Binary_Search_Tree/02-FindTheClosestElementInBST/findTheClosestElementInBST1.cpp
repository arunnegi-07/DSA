// Approach 1 : TC : O(Height of BST)  SC : O(Height of BST)  --> Always 
// Because we are traversing whole tree everytime even though we would have overcome it by just using
// the property of BST, so that we will apply in Approach 2 of this problem.
